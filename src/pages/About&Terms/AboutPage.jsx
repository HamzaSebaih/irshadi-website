    ...
    <div className="min-h-screen bg-white p-8 text-gray-800">
      ...
      >
        ...
        <p className="text-lg text-gray-700 mb-12">
          Irshadi website helps students and faculty members easily manage course registration. It organizes schedules, makes choosing courses simpler, and helps everyone feel more confident about their semester plans.
        </p>
      </motion.div>
